<template>
  ...
  <div class="pb4">
    ...
    <div class="h2 max-width-4 center mx-auto">
      ...
      <div><clv speed="120" no-moves="true" class=" bg-green no-hover  no-border" id="heart"  moveString="D3E3F4G5F3F2G3D2E6C4C3C2B4D6F5G2C5B5C6B3G4E7D7E8G6H3H4H5F6F7"></clv></div>
