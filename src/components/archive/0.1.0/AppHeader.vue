<template>
  <div class="overflow-hidden">
    <header class="fixed justify-end z3 top-0 left-0 right-0 flex bg-purple items-center white">
      <div
        class="only-mobile cursor mx2 h2 "
      ...
      <ul
        ...
        <li class="inline-block mr2">
          <router-link
            to="/"
            class="white">Clovers</router-link>
        </li>
        <li class="inline-block mr2">
          <router-link
            to="/about"
            class="white">About</router-link></li>
        <li class="inline-block mr2">
          <router-link
            to="/activity"
            class="white">Activity</router-link></li>
        <li class="inline-block mr2">
          <router-link
            :to="'/users/' + (username.address || '')"
            class="white"
            v-html="'Wallet &nbsp;' + (userName || '')"/>
        </li>
