<template>
  ...
  <div class="pb4">
    ...
    <div class="h2 max-width-4 center mx-auto">
      ...
      <div class="my4 pb4">When you have successfuly mined a Clover, you can claim it on the blockchain and you will be compensated Coins based on its rarity.</div>
    ...
    <div class="bg-dark-gray white px2 py4 zig-zag-white relative ">
      <div class="max-width-3 mx-auto flex justify-around">
        ...
        <img
          class="pr2"
          src="/static/about-flip-right.svg"
          style="height: 200px;">
      </div>
    </div>
    <div class="h2 max-width-4 center mx-auto">
      ...
      <div
        ...
        <div class="max-width-2 py2 mx-auto">
          <div class="h2 pt4">
            The Contract</div>
          <div class="h4 my2">
            Clovers is a Dapp that uses an <b>Ethereum Contract</b> on the <a
              target="_blank"
              href="https://www.rinkeby.io/">Rinkeby Test Network</a> located at <a
                href="https://rinkeby.etherscan.io/address/0xcc0604514f71b8d39e13315d59f4115702b42646"
                target="_blank">0xcc0604514f71b8d39e13315d59f4115702b42646</a>. The contract is an extension of <a
                  href="https://github.com/OpenZeppelin/zeppelin-solidity/tree/master/contracts/token"
                  target="_blank">OpenZeppelin's ERC20 Token Contract</a> which adheres to the global standard for Ethereum Tokens. Instead of using a traditional mining system Clovers uses the game <a
                    href="https://en.wikipedia.org/wiki/Reversi"
                    target="_blank">Reversi</a> and its massive game tree as a <a
                      href="https://en.wikipedia.org/wiki/Proof-of-work_system"
                      target="_blank">proof of work system</a>. In order to successfully "mine" a block one must search the Reversi game tree (estimated at 10^28 possible games) for a unique endgame which displays <b>symmetry</b>. The symmetry can be on the perpendicular X or Y axis, on the diagonal X = Y or X = -Y axis, or it can be rotationally symmetrical. The miner is rewarded in <a
