<template>
  <div>
    ...
    <div
      :class="{'expanded-500': showHistory}"
      class=" expandable ">
      <div class="p2 ">
          ...
          <table class="col-12 my2">
            ...
            <tbody>
              <tr
                ...
                <td>
                  <router-link
                    :to="userLink(event.data.newOwner)"
                    class=" color-inherit">{{ userName(event.data.newOwner) }}</router-link>
                </td>
              ...
              <tr
                ...
                <td>
                  <router-link
                    :to=" (founder && userLink(founder.address)) || ''"
                    class=" color-inherit">{{ (founder && userName(founder.address)) || '' }}</router-link>
                </td>
                <td>0 &clubs;</td>
