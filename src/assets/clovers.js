...
class Clover extends Reversi {
      ...
      if (web3Provider) {
        ...
        _web3.eth.net.getId((err, netId) => {
          if (!err) {
            this.network = netId
            if (
              CloversController.networks[this.network] &&
              Clovers.networks[this.network] &&
              ClubToken.networks[this.network]
            ) {
  ...
  deployContracts () {
    ...
    console.log(
      'CloversController',
      CloversController.networks[this.network].address
    )
    this.ClubToken = new _web3.eth.Contract(
      ClubToken.abi,
      ClubToken.networks[this.network].address
    )
    this.Clovers = new _web3.eth.Contract(
      Clovers.abi,
      Clovers.networks[this.network].address
    )
    this.CloversController = new _web3.eth.Contract(
      CloversController.abi,
      CloversController.networks[this.network].address
    )
  }
  ...
  cloversControllerOwner () {
    return this.CloversController.methods
      .owner()
      .call()
      .then(resp => {
        return resp
  ...
  getMovesHash (_tokenId) {
    return this.CloversController.methods
      .getMovesHash(new BN(_tokenId, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  claimClover (moves, _tokenId, _symmetries, _to, stakeAmount) {
    ...
    return this.CloversController.methods
      .claimClover(moves, _tokenId, _symmetries, _to)
      .send({
        from: this.account,
        value: stakeAmount
      })
  ...
  claimCloverCommit (movesHash, _to, stakeAmount) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .claimCloverCommit(movesHash, _to)
      .send({
        from: this.account,
        value: stakeAmount
      })
  ...
  tokenFallback (from_, value_, data_) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .tokenFallback(from_, new BN(value_, 10), data_)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  claimCloverReveal (moves, _tokenId, _symmetries) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .claimCloverReveal(moves, new BN(_tokenId, 10), _symmetries)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  retrieveStake (_tokenId) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .retrieveStake(new BN(_tokenId, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  challengeClover (_tokenId, _to) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .challengeClover(new BN(_tokenId, 10), _to)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  updateStakeAmount (_stakeAmount) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .updateStakeAmount(new BN(_stakeAmount, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  updateStakePeriod (_stakePeriod) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .updateStakePeriod(new BN(_stakePeriod, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  updatePayMultipier (_payMultiplier) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.CloversController.methods
      .updatePayMultipier(new BN(_payMultiplier, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  getApproved (_tokenId) {
    return this.Clovers.methods
      .getApproved(new BN(_tokenId, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  tokenOfOwnerByIndex (_owner, _index) {
    return this.Clovers.methods
      .tokenOfOwnerByIndex(_owner, new BN(_index, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  getBlockMinted (_tokenId) {
    return this.Clovers.methods
      .getBlockMinted(new BN(_tokenId, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  getCloverMoves (_tokenId) {
    return this.Clovers.methods
      .getCloverMoves(new BN(_tokenId, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  getSymmetries (_tokenId) {
    return this.Clovers.methods
      .getSymmetries(new BN(_tokenId, 10))
      .call()
      .then(resp => {
        return resp
      })
  ...
  cloversApprove (_to, _tokenId) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .approve(_to, new BN(_tokenId, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  cloversTransferFrom (_from, _to, _tokenId) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .transferFrom(_from, _to, new BN(_tokenId, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  safeTransferFrom (_from, _to, _tokenId) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .safeTransferFrom(_from, _to, new BN(_tokenId, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  safeTransferFromWithData (_from, _to, _tokenId, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .safeTransferFrom(_from, _to, new BN(_tokenId, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  moveToken (amount, _to, token) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .moveToken(new BN(amount, 10), _to, token)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  approveToken (amount, _to, token) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .approveToken(new BN(amount, 10), _to, token)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  setStake (movesHash, stake) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .setStake(movesHash, new BN(stake, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  setBlockMinted (_tokenId, value) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .setBlockMinted(new BN(_tokenId, 10), new BN(value, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  setCloverMoves (_tokenId, moves) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .setCloverMoves(new BN(_tokenId, 10), moves)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  setReward (_tokenId, _amount) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .setReward(new BN(_tokenId, 10), new BN(_amount, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  setSymmetries (_tokenId, _symmetries) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .setSymmetries(new BN(_tokenId, 10), _symmetries)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  deleteClover (_tokenId) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.Clovers.methods
      .deleteClover(new BN(_tokenId, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  clubTokenApprove (_spender, _value) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .approve(_spender, new BN(_value, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  increaseApprovalWithData (_spender, _addedValue, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .increaseApproval(_spender, new BN(_addedValue, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  clubTokenApproveWithData (_spender, _value, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .approve(_spender, new BN(_value, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  decreaseApproval (_spender, _subtractedValue) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .decreaseApproval(_spender, new BN(_subtractedValue, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  decreaseApprovalWithData (_spender, _subtractedValue, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .decreaseApproval(_spender, new BN(_subtractedValue, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  clubTokenTransferFromWithData (_from, _to, _value, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .transferFrom(_from, _to, new BN(_value, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  transferWithData (_to, _value, _data) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .transfer(_to, new BN(_value, 10), _data)
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
  ...
  increaseApproval (_spender, _addedValue) {
    if (!this.account) return Promise.reject(new Error('Unlock Account'))
    return this.ClubToken.methods
      .increaseApproval(_spender, new BN(_addedValue, 10))
      .send({ from: this.account })
      .on('transactionHash', hash => {
        console.log(hash)
        this.loading = true
