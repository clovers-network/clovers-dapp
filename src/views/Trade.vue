  ...
  section
    ...
    section
      .flex.flex-column
        ...
        //- details
        .col-12.flex.flex-wrap.justify-around.border.top-border-0.green.rounded-bottom.py2.center(:class="{'flex-order_-1': isRFT}")
          //- price
...
export default {
  ...
  components: { ViewNav, Chart, WaveyMenu, MoreInformation }
}
</script>
